        ...
        >
          ...
          >
            ...
            <div className="jcard__media">
              ...
              >
                <BlobImage src={heroImg} seed={500 + activeIndex * 17 + photoIdx} count={5} duration={6} />
              </motion.div>
            </div>
            ...
            <div className="jcard__body">
              ...
              <p className="jcard__sub">{item.desc.split("\n")[0]}</p>
              ...
              <a className="jcard__cta" href="/blog">
                VIEW FULL JOURNEY <span>→</span>
              </a>
            </div>
              ...
              <div className="jcard__thumbs-row">
                {gallery.map((g, i) => (
                  <button
                    ...
                    aria-label={`画像 ${i + 1}`}
                  >
                    <BlobImage src={g} seed={700 + i * 9} count={4} duration={7} />
                  </button>
                ))}
              </div>
              <button
