...
const items = [
  ...
  },
  {
    ...
    svg: (
      <path d="M19.6 6.6c-1.6-.4-2.9-1.5-3.6-3a4.6 4.6 0 0 1-.4-1.6h-3.5v13.4a2.8 2.8 0 1 1-2-2.7v-3.5a6.3 6.3 0 1 0 5.5 6.2V8.7a8.1 8.1 0 0 0 4.7 1.5V6.7c-.2 0-.5-.05-.7-.1z" />
    ),
  },
  {
    label: "Instagram",
  ...
  },
  {
    ...
    svg: <path d="M6 6h2.6l6.4 8.4V6H18v12h-2.6L9 9.6V18H6V6z" />,
  },
];
